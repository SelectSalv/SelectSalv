...
call p_regMunicipio('Metapán', 3);
call p_regMunicipio('San Antonio Pajonal', 3);
call p_regMunicipio('San Sebastián Salitrillo', 3);
call p_regMunicipio('Santa Ana', 3);
call p_regMunicipio('Santa Rosa Guachipilín', 3);
...
call p_regMunicipio('Juayúa', 4);
call p_regMunicipio('Nahuizalco', 4);
call p_regMunicipio('Nahulingo', 4);
call p_regMunicipio('Salcoatitán', 4);
call p_regMunicipio('San Antonio del Monte', 4);
call p_regMunicipio('San Julián', 4);
call p_regMunicipio('Santa Catarina Masahuat', 4);
call p_regMunicipio('Santa Isabel Ishuatán', 4);
call p_regMunicipio('Santo Domingo de Guzmán', 4);
...
call p_regMunicipio('Comacarán', 5);
call p_regMunicipio('El Tránsito', 5);
call p_regMunicipio('Lolotique', 5);
call p_regMunicipio('Moncagua', 5);
call p_regMunicipio('Nueva Guadalupe', 5);
call p_regMunicipio('Nuevo Edén de San Juan', 5);
...
call p_regMunicipio('Santa María Ostuma', 8);
call p_regMunicipio('Santiago Nonualco', 8);
 call p_regMunicipio('Tapalhuaca', 8);

/*LA UNION*/
call p_regMunicipio('La Unión', 9);
call p_regMunicipio('San Alejo', 9);
call p_regMunicipio('Yucuaiquín', 9);
call p_regMunicipio('Conchagua', 9);
call p_regMunicipio('Intipucá', 9);
call p_regMunicipio('San José', 9);
call p_regMunicipio('El Carmen (La Unión)', 9);
call p_regMunicipio('Yayantique', 9);
call p_regMunicipio('Bolívar', 9);
...
call p_regMunicipio('Concepción de Oriente', 9);
call p_regMunicipio('Polorós', 9);
call p_regMunicipio('Lislique', 9);

/*CUSCATLAN*/
call p_regMunicipio('Cojutepeque', 10);
call p_regMunicipio('Candelaria', 10);
call p_regMunicipio('El Carmen (Cuscatlán)', 10);
call p_regMunicipio('El Rosario (Cuscatlán)', 10);
call p_regMunicipio('Monte San Juan', 10);
call p_regMunicipio('Oratorio de Concepción', 10);
call p_regMunicipio('San Bartolomé Perulapía', 10);
call p_regMunicipio('San Cristóbal', 10);
call p_regMunicipio('San José Guayabal', 10);
call p_regMunicipio('San Pedro Perulapán', 10);
call p_regMunicipio('San Rafael Cedros', 10);
call p_regMunicipio('San Ramón', 10);
...
call p_regMunicipio('Citalá', 11);
call p_regMunicipio('Comapala', 11);
call p_regMunicipio('Concepción Quezaltepeque', 11);
call p_regMunicipio('Dulce Nombre de María', 11);
call p_regMunicipio('El Carrizal', 11);
call p_regMunicipio('El Paraíso', 11);
...
call p_regMunicipio('Nueva Concepción', 11);
call p_regMunicipio('Nueva Trinidad', 11);
call p_regMunicipio('Nombre de Jesús', 11);
 ...
 call p_regMunicipio('San Antonio Los Ranchos', 11);
  call p_regMunicipio('San Fernando (Chalatenango)', 11);
   call p_regMunicipio('San Francisco Lempa', 11);
    call p_regMunicipio('San Francisco Morazán', 11);
...
call p_regMunicipio('Delicias de Concepción', 12);
call p_regMunicipio('El Divisadero', 12);
call p_regMunicipio('El Rosario (Morazán)', 12);
...
call p_regMunicipio('Perquín', 12);
call p_regMunicipio('San Carlos', 12);
call p_regMunicipio('San Fernando (Morazán)', 12);
call p_regMunicipio('San Francisco Gotera', 12);
call p_regMunicipio('San Isidro (Morazán)', 12);
call p_regMunicipio('San Simón', 12);
 call p_regMunicipio('Sensembra', 12);
  call p_regMunicipio('Sociedad', 12);
   call p_regMunicipio('Torola', 12);
    ...
    call p_regMunicipio('Yoloaiquín', 12);
...
call p_regMunicipio('San Sebastián', 13);
...
call p_regMunicipio('Tepetitán', 13);
