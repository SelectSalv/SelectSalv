	<nav id="barraPersona" class="navbar fixed-top d-flex">
		...
		<a class="navbar-brand text-header-boleta p2 mr-auto" style="color: #fff; font-family: 'Proxima-Regular';"><?php echo $_SESSION["municipioPersona"].", ".$_SESSION["departamentoPersona"] ?></a>
		<div class="persona">
			<a class="nombre-header" style="color: #fff;" class="float-right p2 mr-auto navbar-text">
				...
				<br>
				<small class="float-right mr-auto" style=""><?php echo $_SESSION["duiPersona"] ?></small>
			</a>
		</div>
	</nav>
